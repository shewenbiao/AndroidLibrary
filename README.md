...
## <a name="index">Index </a> 
   ...
   * <a href="#5">6. JSON解析</a>  
   * <a href="#6">7. 异步链式框架</a>  
   * <a href="#7">8. 组件/模块路由，通信框架</a>  
   * <a href="#8">9. 注解</a>  
   * <a href="#9">10. 文件上传/下载</a>  
   * <a href="#10">11. 视频播放器</a>  
   * <a href="#11">12. 扫码库</a>  
   * <a href="#12">13. 工具类</a>  
   * <a href="#13">14. 日志类</a>  
   * <a href="#14">15. 性能检测</a>  
   * <a href="#15">16. 插件化框架</a>  
   * <a href="#16">17. 热修复框架</a>  
   * <a href="#17">18. UI框架</a>  
      * <a href="#18">18.1. 图片</a>  
         * <a href="#19">18.1.1. 图片裁剪</a>  
         * <a href="#20">18.1.2. 显示GIF图片的控件</a>  
         * <a href="#21">18.1.3. 图片压缩</a>  
         * <a href="#22">18.1.4. 图片毛玻璃、模糊处理库</a>  
         * <a href="#23">18.1.5. 图片滤镜</a>  
         * <a href="#24">18.1.6. 图片展示控件</a>  
         * <a href="#25">18.1.7. 图片选择器</a>  
...
## <a name="5">6. JSON解析</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="6">7. 异步链式框架</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="7">8. 组件/模块路由，通信框架</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="8">9. 注解</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="9">10. 文件上传/下载</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="10">11. 视频播放器</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="11">12. 扫码库</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
| zxing    | 适用于 Java、Android 的条码扫描库。ZXing（“斑马线”）是一个开源的、多格式的一维/二维条码图像处理库，用 Java 实现，可移植到其他语言。    | ----    | ----    | https://github.com/zxing/zxing    |


## <a name="12">13. 工具类</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="13">14. 日志类</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="14">15. 性能检测</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="15">16. 插件化框架</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
## <a name="16">17. 热修复框架</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
| tinker   | Tinker 是一款安卓热修复解决方案库，支持dex、库和资源更新，无需重新安装apk。 | ---    | ---  | https://github.com/Tencent/tinker  |


## <a name="17">18. UI框架</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
### <a name="18">18.1. 图片</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

#### <a name="19">18.1.1. 图片裁剪</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
| uCrop    | 提供终极且灵活的图像裁剪体验。 | ---   | --- |https://github.com/Yalantis/uCrop |


#### <a name="20">18.1.2. 显示GIF图片的控件</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
#### <a name="21">18.1.3. 图片压缩</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
| Luban | Luban（鲁班） —— Android图片压缩工具，仿微信朋友圈压缩策略。可能是最接近微信朋友圈的图片压缩算法 | ---   | --- | https://github.com/Curzibn/Luban |


#### <a name="22">18.1.4. 图片毛玻璃、模糊处理库</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
#### <a name="23">18.1.5. 图片滤镜</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
#### <a name="24">18.1.6. 图片展示控件</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
...
#### <a name="25">18.1.7. 图片选择器</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
| 主流框架  | 介绍  | 优点  | 缺点  |  官网或相关地址      |
|:----------|:----------|:----------|:----------|:----------|
